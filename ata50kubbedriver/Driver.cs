...
//
// ASCOM Dome driver for ATA50KubbeDriver
//
// Description:	bir driver dan daha fazlasi..
...
// -----------	---	-----	-------------------------------------------------------
// dd-mmm-yyyy	HC	0.0.1	Initial edit, created from ASCOM driver template
// --------------------------------------------------------------------------------
//
...
namespace ASCOM.ATA50KubbeDriver
{
    //
    // Your driver's DeviceID is ASCOM.ATA50KubbeDriver.Dome
    //
    // The Guid attribute sets the CLSID for ASCOM.ATA50KubbeDriver.Dome
    // The ClassInterface/None addribute prevents an empty interface called
    // _ATA50KubbeDriver from being created and used as the [default] interface
    //
    ...
    /// ASCOM Dome Driver for ATA50KubbeDriver.
    /// </summary>
    [Guid("0b72f65e-9a72-4c5e-a310-7d56a33f8d7f")]
    ...
    public class Dome : IDomeV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.ATA50KubbeDriver.Dome";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Dome Driver for ATA50KubbeDriver.";
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    tl.LogMessage("Connected Set", "Disconnecting from 10.141.3.110 " );
...
//
        ...
        //komutgonder fonksiyonu tanimlamasi.. 


        public void komutgonder(string cmd)
        {
            try
            {
                Thread.Sleep(50);
       ...
       private void cevapoku(ShellStream stream)
        ...
        //kontrol fonksiyonu tanimlamasi
       ...
       public void kontrol()
       {
           if (ssh.IsConnected)
           {
               try
               {
                   ...
                   {
                       tl.LogMessage("kapali","kubbe kapali konumdadir..");
                   }
                   else
                   {
                       tl.LogMessage("hata","hata var, bagli degilsiniz ya da cok sik komut gonderdiniz..");

                   }
               }
               catch 
               {
                   tl.LogMessage("hata", "yavas basin suna kardesim :) ");
               }
        ...
        public void CloseShutter()
        {
            ...
            {
                tl.LogMessage("bagli degil", "bagli degilsiniz ya da cok sik komut gonderiyorsunuz..");
            }
        }
        ...
        private bool IsConnected
        {
            get
            {
                if (ssh.IsConnected)
                {
                    connectedState = ssh.IsConnected;
        ...
        internal void ReadProfile()
        {
            ...
            {
               // tl.LogMessage("Slewingddeneme Get", "denemd");
